<div x-data wire:ignore x-init="() => {
	...
	">
	<select id="{{ $attributes['prettyname'] }}" wire-model="{{ $attributes['wire:model.live'] }}" wire:change="{{ $attributes['wire:change'] }}" x-ref="{{ $attributes['prettyname'] }}"   {{$attributes["multiple"]}}>
