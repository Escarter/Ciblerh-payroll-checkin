            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{__('Record overtime worked')}}</h1>
                        <p>{{__('Record and submit any overtime you did')}} &#128555;</p>
                    </div>
                    <x-form-items.form wire:submit.prevent="store" enctype="multipart/form-data" class="form-modal">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" wire:click.prevent="store" class="btn btn-secondary " wire:loading.attr="disabled">{{__('Submit Overtime')}}</button>
                        </div>
                    </x-form-items.form>
                </div>
            </div>
