                        ...
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{numberFormat($approved_absence)}} {{ \Str::plural(__('employees.absence'), $approved_absence) }} </h5>
                    ...
                    <div class='border-prim p-3 rounded'>
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{numberFormat($pending_absence)}} {{ \Str::plural(__('employees.absence'), $pending_absence) }} </h5>
                    ...
                    <div class='border-prim p-3 rounded'>
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{numberFormat($rejected_absence)}} {{ \Str::plural(__('employees.absence'), $rejected_absence) }}</h5>
                ...
                <table class="table employee-table table-hover align-items-center dataTable" id="datatable">
                    <thead class="">
                        <tr>
                            ...
                            <th class="border-0 px-4 py-2 text-muted fw-medium">{{__('employees.attachment_link')}}</th>
