            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{__('Request Advance Salary')}}</h1>
                        <p>{{__('Create and submit an advance salary request')}} &#128530;</p>
                    </div>
                    <x-form-items.form wire:submit.prevent="store" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" wire:click.prevent="store" class="btn btn-secondary " wire:loading.attr="disabled">{{__('Submit Request')}}</button>
                        </div>
                    </x-form-items.form>
                </div>
            </div>
