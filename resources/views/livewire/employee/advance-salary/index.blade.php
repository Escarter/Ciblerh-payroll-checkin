                        ...
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{number_format($approved_advance_salary)}} {{ __(\Illuminate\Support\Str::plural(__('employees.advance_salary'), $approved_advance_salary)) }}</h5>
                    ...
                    <div class='border-prim p-3 rounded'>
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{number_format($pending_advance_salary)}} {{ __(\Illuminate\Support\Str::plural(__('employees.advance_salary'), $pending_advance_salary))}} </h5>
                    ...
                    <div class='border-prim p-3 rounded'>
                        <a href="#" class="d-flex  justify-content-between align-items-center gap-1">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <h5 class="text-gray-700 fw-bold mb-0">{{number_format($rejected_advance_salary)}} {{ __(\Illuminate\Support\Str::plural(__('employees.advance_salary'), $rejected_advance_salary)) }}</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-check d-flex justify-content-center align-items-center">
                                    @if($activeTab === 'active')
                                        @if($advance_salary->approval_status !== $APPROVAL_STATUS_APPROVED)
