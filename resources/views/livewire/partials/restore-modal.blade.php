            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="button" wire:click="restore($wire.job_id)" id="confirm-restore-btn" class="btn btn-success mx-3" data-bs-dismiss="modal">{{__('common.confirm_restore')}}</button>
