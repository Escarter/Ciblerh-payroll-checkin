                ...
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <h1 class="mb-0 h2 fw-bolder">{{__('common.are_you_sure')}}</h1>
                            <p class="pt-2">{{__('common.you_are_about_to_move')}} <strong>{{ count($selectedItems ?? []) }} {{ $itemType ?? __('common.items') }}</strong> {{__('common.to_trash_this_action_can_be_undone_later') }} &#128522;</p>
                    </div>
