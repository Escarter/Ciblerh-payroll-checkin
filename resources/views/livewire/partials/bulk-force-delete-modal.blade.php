            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('common.you_are_about_to_permanently_delete')}} <strong>{{ count($selectedEmployees) }} {{ count($selectedEmployees) === 1 ? __('employee') : __('employees') }}</strong> {{__('common.from_the_system')}}</p>
