<div wire:ignore.self class="modal fade" id="BulkForceDeleteModal" tabindex="-1" role="dialog" aria-labelledby="bulkForceDeleteModal" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('You are about to permanently delete')}} <strong>{{ count($selectedEmployees) }} {{ count($selectedEmployees) === 1 ? __('employee') : __('employees') }}</strong> {{__('from the system.')}}</p>
                        <p class="text-danger fw-bold">{{__('This action cannot be undone!')}}</p>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="button" wire:click="bulkForceDelete" class="btn btn-danger mx-3" data-bs-dismiss="modal">{{__('Delete Forever')}}</button>
