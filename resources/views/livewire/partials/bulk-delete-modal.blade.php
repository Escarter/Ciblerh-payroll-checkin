            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('You are about to move')}} <strong>{{ count($selectedEmployees) }} {{ count($selectedEmployees) === 1 ? __('employee') : __('employees') }}</strong> {{__('to trash. This action can be undone later.')}}</p>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="button" wire:click="bulkDelete" class="btn btn-danger mx-3" data-bs-dismiss="modal">{{__('Move to Trash')}}</button>
