            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('common.you_are_about_to_move')}} <strong>{{ count($selectedEmployees) }} {{ count($selectedEmployees) === 1 ? __('employee') : __('employees') }}</strong> {{__('common.to_trash_this_action_can_be_undone_later')}}</p>
                    </div>
