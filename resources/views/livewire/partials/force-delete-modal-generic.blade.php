            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('common.you_are_about_to_permanently_delete_this')}} <strong>{{ $itemType ?? __('common.item') }}</strong> {{__('common.from_the_system')}}</p>
                        ...
                        <div class="alert alert-warning d-flex align-items-center mt-3" role="alert">
                            ...
                            <div>
                                <strong>{{__('common.warning')}}</strong> {{__('common.related_records_protection')}}
                            </div>
                        </div>
                    </div>
