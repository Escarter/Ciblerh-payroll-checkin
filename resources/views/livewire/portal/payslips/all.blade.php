    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <button class="btn {{ $activeTab === 'deleted' ? 'btn-danger' : 'btn-outline-danger' }}"
                ...
                {{__('common.deleted')}}
                <span class="badge {{ $activeTab === 'deleted' ? 'bg-light text-white' : 'bg-danger text-white' }} ms-1">{{ $deleted_jobs ?? 0 }}</span>
            </button>
        </div>
        <div>
            @if($activeTab === 'active')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Go to Details Page -->
                            <a href="/portal/payslips/{{$job->id}}/details" wire:navigate class="text-info me-2" title="{{__('payslips.view_details_download_payslips')}}">
                                <svg class="icon icon-xs" fill="none" stroke="currentColor" viewBox="0 0 24 24">
