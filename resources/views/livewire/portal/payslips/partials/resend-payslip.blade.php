<div wire:ignore.self class="modal fade" id="resendPayslipModal" tabindex="-1" role="dialog" aria-labelledby="createPost" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">{{__('payslips.you_are_about_to_resend_email_and_sms_with_employee_payslip')}} &#128522;</p>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="button" wire:click="resendPayslip" class="btn btn-primary mx-3" data-dismiss="modal">{{__('common.confirm')}}</button>
