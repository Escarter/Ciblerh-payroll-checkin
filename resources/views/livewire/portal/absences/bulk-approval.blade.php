            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{__('Bulk Absence')}} {{$bulk_approval_status ? __('Approval') : __('Rejection')}} </h1>
                        <p>{{__('Employee Absence Bulk')}} {{$bulk_approval_status ? __('Approval') : __('Rejection')}} &#128522;</p>
                    </div>
