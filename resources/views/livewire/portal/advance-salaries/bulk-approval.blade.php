                ...
                <div class="p-3 p-lg-4">
                    ...
                    <x-form-items.form wire:submit="bulkApproval">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea wire:model="approval_reason" name="approval_reason" class="form-control  @error('approval_reason') is-invalid @enderror" id="bulk_approval_reason" cols='3' rows="3"></textarea>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" wire:click.prevent="bulkApproval" id="bulk-advance-salary-confirm-btn" class="btn btn-{{$bulk_approval_status ? 'success' : 'danger'}} text-white " wire:loading.attr="disabled">{{$bulk_approval_status ? __('common.approve') : __('common.reject')}}</button>
                        </div>
                    </x-form-items.form>
                </div>
            </div>
