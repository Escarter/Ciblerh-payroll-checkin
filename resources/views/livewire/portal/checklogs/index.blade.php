    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <button id="deleted-checklogs-tab" class="btn {{ $activeTab === 'deleted' ? 'btn-danger' : 'btn-outline-danger' }}"
                ...
                {{__('common.deleted')}}
                <span class="badge {{ $activeTab === 'deleted' ? 'bg-light text-white' : 'bg-danger text-white' }} ms-1">{{ $deleted_checklogs ?? 0 }}</span>
            </button>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($activeTab === 'active')
                            @can('ticking-update')
                            <a href="#" id="view-checklog-btn-{{ $checklog->id }}" wire:click="initData({{ $checklog->id }})" data-bs-toggle="modal" data-bs-target="#EditChecklogModal">
