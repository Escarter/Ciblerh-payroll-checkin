             ...
             <div class="modal-body p-0">
                 <div class="p-3 p-lg-4">
                     <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{__('common.import_name',['name'=>__('departments.departments')])}}</h1>
                        <p>{{__('common.import_new_name_from_excel',['name'=>__('departments.departments')])}} &#128522;</p>

                     </div>
                     <x-form-items.form wire:submit="import" class="form-modal">
                         <p>{{__('common.import_steps',['name'=>__('departments.departments')])}}</p>
                         <div class='mb-4'>
                            <ol>
                         ...
                         <div class="d-flex justify-content-end">
                             ...
                             <button class=" btn btn-primary" type="submit" wire:click.prevent="import" wire:loading.attr="disabled" {{empty($department_file) ? "disabled" : '' }}>{{__('common.import')}}</button>
                         </div>
                     </x-form-items.form>
                 </div>
             </div>
