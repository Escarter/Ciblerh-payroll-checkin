<div wire:ignore.self class="modal side-layout-modal fade" id="DepartmentSmsToggleModal" tabindex="-1" role="dialog" aria-labelledby="departmentSmsToggleModal" aria-hidden="true">
