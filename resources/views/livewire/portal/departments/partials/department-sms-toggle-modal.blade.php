            ...
            <div class="modal-body">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">
                            @if($pendingSmsDepartmentEnabled === true)
                                {{ __('departments.bulk_sms_enable_confirm_department_name', ['department' => $pendingSmsDepartmentName ?? __('departments.department')]) }}
                            @else
                                {{ __('departments.bulk_sms_disable_confirm_department_name', ['department' => $pendingSmsDepartmentName ?? __('departments.department')]) }}
                            @endif
                        </p>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button type="button" wire:click="executeDepartmentSmsToggle" class="btn btn-danger mx-3" data-bs-dismiss="modal">{{ __('common.confirm') }}</button>
