                ...
                <table class="table table-hover table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="{{in_array($job->id, $selectedJobs) ? 'table-primary' : ''}}">
                            ...
                            <td>
                                <span class="badge bg-primary">{{$job->import_type_display}}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge bg-{{$job->status_badge}}">{{$job->status_display}}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a href="#" wire:click="viewJobDetails({{$job->id}})" title="{{__('import_jobs.view_details')}}">
                                        <svg class="icon icon-sm text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="#" wire:click="cancelJob({{$job->id}})" wire:confirm="{{__('import_jobs.confirm_cancel_job')}}" title="{{__('import_jobs.cancel_job')}}">
                                        <svg class="icon icon-sm text-warning" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                        </svg>
                                    </a>
                                    @endif
