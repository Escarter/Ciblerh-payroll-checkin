<div>
    ...
    <div class="row py-3">
        <div class="col-md-3">
            ...
            <input wire:model.live="query" id="overtimes-search" type="text" placeholder="{{__('common.search_placeholder')}}" class="form-control">
            <p class="badge badge-info" wire:model.live="resultCount">{{$resultCount}}</p>
        </div>
        <div class="col-md-3">
            <label for="orderBy">{{__('common.order_by')}}: </label>
            <select wire:model.live="orderBy" id="overtimes-order-by" class="form-select">
        ...
        <div class="col-md-3">
            ...
            <select wire:model.live="perPage" id="overtimes-per-page" class="form-select">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <button id="deleted-overtimes-tab" class="btn {{ $activeTab === 'deleted' ? 'btn-danger' : 'btn-outline-danger' }}"
                ...
                {{__('common.deleted')}}
                <span class="badge {{ $activeTab === 'deleted' ? 'bg-light text-white' : 'bg-danger text-white' }} ms-1">{{ $deleted_overtimes ?? 0 }}</span>
            </button>
        </div>
