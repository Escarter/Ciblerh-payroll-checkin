 {{-- Import modal removed - now redirects to centralized import system --}}
{{-- Original modal content preserved for reference --}}
@php
    // This component now redirects to the centralized import system
    // The import button in the companies index will redirect to /portal/import-jobs
@endphp
     <div class="modal-dialog modal-dialog-centered modal-xl" style="max-width: 950px;" >
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title fw-bold" id="importCompaniesModalLabel">
                     <span x-show="currentStep === 'upload'">{{__('Import :name',['name'=>__('companies.company')])}}</span>
                 ...
                 <div x-show="currentStep === 'upload'" x-transition x-transition.duration.300ms>
                     <div class="px-3 pt-1 pb-3">
                         <x-form-items.form class="form-modal">
                             <p>{{__('common.import_steps',['name'=>__('companies.company')])}}</p>
                             <div class='mb-4'>
                                <ol>
                                    <li>{{__('common.download_sample_import_template',['name'=>__('companies.company')])}}
                                        <a href="{{asset('templates/import_companies.xlsx')}}" class="btn btn-sm btn-outline-success ms-2" download>
                                    ...
                                    <li>{{__('common.fill_template_with_data',['name'=>__('companies.company')])}}</li>
                                    <li>{{__('common.upload_filled_template')}}</li>
                                </ol>
                             </div>
                             <div class="mb-4">
                                 <label for="company_file" class="form-label">{{__('common.select_file')}}</label>
                                 <input wire:model="company_file" class="form-control @error('company_file') is-invalid @enderror" type="file" name="company_file" id="formFile" accept=".csv,.xlsx,.xls,.txt">
                                 @error('company_file')
                             ...
                             <div class="col-md-6">
                                 <div class="card">
                                     <div class="card-body">
                                         ...
                                         <ul class="list-unstyled">
                                             <li><strong>{{ __('common.file_name') }}:</strong> {{ $company_file ? $company_file->getClientOriginalName() : __('common.none') }}</li>
                                         </ul>
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="modal-footer">
                 <div x-show="currentStep === 'upload'">
                     ...
                     <button type="button" class="btn btn-primary" wire:click="processPreview" wire:loading.attr="disabled" :disabled="!$wire.company_file || $wire.isProcessingPreview">
