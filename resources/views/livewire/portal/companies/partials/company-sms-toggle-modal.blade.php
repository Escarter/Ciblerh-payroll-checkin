                    ...
                    <div class="mb-4 mt-md-0 text-center">
                        ...
                        <p class="pt-2">
                            @if($pendingSmsCompanyEnabled === true)
                                {{ __('companies.bulk_sms_enable_confirm_company_name', ['company' => $pendingSmsCompanyName ?? __('companies.company')]) }}
                            @else
                                {{ __('companies.bulk_sms_disable_confirm_company_name', ['company' => $pendingSmsCompanyName ?? __('companies.company')]) }}
                            @endif
                        </p>
                    </div>
