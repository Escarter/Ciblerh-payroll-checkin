        ...
        <div class="d-flex justify-content-between w-100 flex-wrap align-items-center">
            ...
            <div class="mb-2 mx-3">
                <div class="btn-toolbar " wire:loading.remove>
                    <a href="#" wire:click.prevent="generateReport()" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center  {{count($overtimes) > 0 ? '' :'disabled'}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="d-flex align-items-center">
                                <div class="avatar-md d-flex align-items-center justify-content-center fw-bold fs-5 rounded bg-secondary me-3"><span class="text-white">{{$overtime->user->initials}}</span></div>
