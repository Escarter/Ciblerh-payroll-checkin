     ...
     <div class="modal-dialog modal-dialog-centered modal-xl" style="max-width: 950px;" >
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title fw-bold" id="importservicesModalLabel">
                     <span x-show="currentStep === 'upload'">{{__('common.import_name',['name'=>__('services.services')])}}</span>
                     ...
                     <div class="px-3 pt-1 pb-3">
                         <x-form-items.form class="form-modal">
                             ...
                             <div class="mb-4">
                                 ...
                                 <input wire:model="service_file" class="form-control @error('service_file') is-invalid @enderror" type="file" name="service_file" id="formFile" accept=".csv,.xlsx,.xls,.txt">
                                 @error('service_file')
                             ...
                             <div class="col-md-6">
                                 <div class="card">
                                     <div class="card-body">
                                         ...
                                         <ul class="list-unstyled">
                                             <li><strong>{{ __('common.file_name') }}:</strong> {{ $service_file ? $service_file->getClientOriginalName() : __('common.none') }}</li>
                                         </ul>
                                     </div>
                                 </div>
                             </div>
             ...
             <div class="modal-footer">
                 <div x-show="currentStep === 'upload'">
                     ...
                     <button type="button" class="btn btn-primary" wire:click="processPreview" wire:loading.attr="disabled" :disabled="!$wire.service_file || $wire.isProcessingPreview">
