...
return [
    /*
    |--------------------------------------------------------------------------
    | Absences Management Language Lines
    |--------------------------------------------------------------------------
    */
    ...
    'manage_employees_absences_request' => 'Manage Employees absences requests!',
    'absence_record' => 'absence record',

    // Bulk operations
    'bulk_absence' => 'Bulk Absence',
    'employee_absence_bulk' => 'Employee absence bulk',

    // Modal titles
    'update_or_approve_absence' => 'Update or Approve Absence',
    'update_or_approve_employee_absence_record' => 'Update or approve employee absence record',

    // Bulk actions
    'move_selected_absence_records_to_trash' => 'Move Selected Absence Records to Trash',
    ...
    'absence_successfully_moved_to_trash' => 'Absence successfully moved to trash!',
    'absence_successfully_restored' => 'Absence successfully restored!',
