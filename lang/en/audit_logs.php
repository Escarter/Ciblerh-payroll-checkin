...
return [
    ...
    */
    ...
    // Bulk Operations (approvals already above)
    'bulk_deleted_absences' => 'Bulk moved :count absence(s) to trash',
    'bulk_restored_absences' => 'Bulk restored :count absence(s)',
    'bulk_force_deleted_absences' => 'Bulk permanently deleted :count absence(s)',
    ...
    'bulk_deleted_overtimes' => 'Bulk moved :count overtime(s) to trash',
    'bulk_restored_overtimes' => 'Bulk restored :count overtime(s)',
    'bulk_force_deleted_overtimes' => 'Bulk permanently deleted :count overtime(s)',
    'bulk_approved_leaves' => 'Bulk approved :count leave(s)',
    'bulk_rejected_leaves' => 'Bulk rejected :count leave(s)',
    'bulk_deleted_leaves' => 'Bulk moved :count leave(s) to trash',
    'bulk_restored_leaves' => 'Bulk restored :count leave(s)',
    'bulk_force_deleted_leaves' => 'Bulk permanently deleted :count leave(s)',
    ...
    'bulk_deleted_advance_salaries' => 'Bulk moved :count advance salary(ies) to trash',
    'bulk_restored_advance_salaries' => 'Bulk restored :count advance salary(ies)',
    'bulk_force_deleted_advance_salaries' => 'Bulk permanently deleted :count advance salary(ies)',
    'bulk_deleted_employees' => 'Bulk moved :count employee(s) to trash',
    'bulk_restored_employees' => 'Bulk restored :count employee(s)',
    'bulk_force_deleted_employees' => 'Bulk permanently deleted :count employee(s)',
    'bulk_deleted_companies' => 'Bulk moved :count company(ies) to trash',
    'bulk_restored_companies' => 'Bulk restored :count company(ies)',
    'bulk_force_deleted_companies' => 'Bulk permanently deleted :count company(ies)',
    'bulk_deleted_departments' => 'Bulk moved :count department(s) to trash',
    'bulk_restored_departments' => 'Bulk restored :count department(s)',
    'bulk_force_deleted_departments' => 'Bulk permanently deleted :count department(s)',
    'bulk_deleted_services' => 'Bulk moved :count service(s) to trash',
    'bulk_restored_services' => 'Bulk restored :count service(s)',
    'bulk_force_deleted_services' => 'Bulk permanently deleted :count service(s)',
    'bulk_deleted_roles' => 'Bulk moved :count role(s) to trash',
    'bulk_restored_roles' => 'Bulk restored :count role(s)',
    'bulk_force_deleted_roles' => 'Bulk permanently deleted :count role(s)',
    'bulk_deleted_leave_types' => 'Bulk moved :count leave type(s) to trash',
    'bulk_restored_leave_types' => 'Bulk restored :count leave type(s)',
    'bulk_force_deleted_leave_types' => 'Bulk permanently deleted :count leave type(s)',
    'bulk_deleted_download_jobs' => 'Bulk moved :count download job(s) to trash',
    'bulk_restored_download_jobs' => 'Bulk restored :count download job(s)',
    'bulk_force_deleted_download_jobs' => 'Bulk permanently deleted :count download job(s)',
    'bulk_deleted_import_jobs' => 'Bulk moved :count import job(s) to trash',
    'bulk_restored_import_jobs' => 'Bulk restored :count import job(s)',
    'bulk_force_deleted_import_jobs' => 'Bulk permanently deleted :count import job(s)',
    'bulk_deleted_payslip_processes' => 'Bulk moved :count payslip process(es) to trash',
    'bulk_restored_payslip_processes' => 'Bulk restored :count payslip process(es)',
    'bulk_force_deleted_payslip_processes' => 'Bulk permanently deleted :count payslip process(es)',
    'bulk_deleted_payslips' => 'Bulk moved :count payslip(s) to trash',
    'bulk_restored_payslips' => 'Bulk restored :count payslip(s)',
    'bulk_force_deleted_payslips' => 'Bulk permanently deleted :count payslip(s)',
    'bulk_created_checklogs' => 'Bulk created :count checklog(s)',
    'bulk_approved_checklogs' => 'Bulk approved :count checklog(s)',
    'bulk_rejected_checklogs' => 'Bulk rejected :count checklog(s)',
    'bulk_deleted_checklogs' => 'Bulk moved :count checklog(s) to trash',
    'bulk_restored_checklogs' => 'Bulk restored :count checklog(s)',
    'bulk_force_deleted_checklogs' => 'Bulk permanently deleted :count checklog(s)',
    'bulk_created_overtimes' => 'Bulk created :count overtime(s)',
