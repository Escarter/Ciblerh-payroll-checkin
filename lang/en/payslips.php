...
return [
    ...
    */
    ...
    'retry_count_info' => ':count of :max attempts',
    'no_retries_yet' => 'No retries attempted yet',
    ...
    'period_process_already_running' => 'A payslip process is already running for :department — :month :year (process #:process_id). Open: :details_url',
    ...
    'bulk_resend_email' => 'Bulk Resend Email',
    ...
    'sms_provider_unhealthy' => 'SMS provider is unhealthy',
    'sms_provider_unhealthy_during_balance_check' => 'SMS provider unhealthy during balance check',
    'sms_provider_not_configured' => 'SMS provider not configured',
    'sms_provider_credentials_not_configured' => 'SMS provider credentials are not configured',
    ...
    'sms_sending_in_progress' => 'SMS sending in progress',
    'sms_not_attempted_email_failed' => 'SMS not attempted - email sending failed',
    ...
    'sftp_validator_description' => 'Review payslip files received via SFTP. High-confidence auto-match validates and sends automatically; other files must be validated manually, then click Process.',
    'pending' => 'Pending',
    'validated' => 'Validated',
    'processed' => 'Processed',
    'rejected' => 'Rejected',
    ...
    'proposal_validated_click_process' => 'Proposal validated. Open the Validated tab and click Process to start sending.',
    'sftp_validated_tab_hint' => 'Auto-matched files are sent automatically when confidence meets your threshold. Manually validated files stay here until you click Process (or select several and use Process selected).',
    'proposal_validated_file_missing' => 'Proposal validated but cannot process yet — :reason',
    'proposal_already_processing' => 'This proposal is already being processed. Wait for the current run to complete.',
    ...
    'only_failed_proposals_can_be_retried' => 'Only failed proposals can be retried',
    'failed_proposal_queued_for_retry' => 'Failed proposal has been queued for retry',
    'retry_failed_proposal' => 'Retry Failed Proposal',
    'rematch' => 'Re-match',
    'rematch_no_candidates' => 'Re-match complete: no company matches found',
    'rematch_found' => 'Re-match complete: :count candidate(s) found',
    'rematch_auto_validated' => 'Re-match complete: :count candidate(s) found — auto-validated and queued for sending.',
    'rematch_processing_error' => 'Re-match completed but processing failed: :error',
    ...
    'pull_now_success' => 'Scan complete: :queued file(s) prepared for validation, :skipped skipped.',
    'pull_now_done' => 'Scan complete. No new local files were found.',
    'pull_now_failed' => 'Failed to pull files: :error',
    'local_file_not_found' => 'Local file no longer exists — cannot re-match',
    'failed_to_load_employees' => 'Cannot load employees: :error',
    'proposals_queued_for_processing' => 'Proposals queued for processing (count: :count)',
    'proposals_queued_with_skips' => 'Processing dispatch complete: :queued queued, :skipped skipped.',
    'proposal_not_ready_for_processing' => 'This proposal is not ready for processing: :reason',
    'processing_blocked_no_company' => 'no company is assigned',
    'processing_blocked_not_downloaded' => 'file download status is not ready',
    'processing_blocked_missing_local_path' => 'local file path is missing',
    'processing_blocked_local_file_missing' => 'local file does not exist on disk',
    ...
    'last_scan_report' => 'Last scan report',
    'scan_handled' => 'Handled',
    'scan_skipped' => 'Skipped',
    'scan_already_indexed' => 'Already indexed',
    'scan_still_uploading' => 'Still uploading',
    'scan_locked' => 'Locked',
    'scan_other' => 'Other',
    'scan_summary' => 'Scan summary',
    'scan_summary_hint' => 'Based on the latest scan run',
    'scan_total_files' => 'Total files',
    'scan_handled_rate' => 'Handled rate',
    'scan_breakdown' => 'Skip breakdown',
    'scan_raw_output' => 'Raw scanner output',
    'auto' => 'auto',
    'current_folder' => 'Current folder',
    'unknown_folder' => 'unknown',
    'movement_reason' => 'Movement reason',
    'details' => 'Details',
    'move_reason_processed' => 'Moved to /processed because downstream payslip processing completed successfully.',
    'move_reason_rejected' => 'Proposal was rejected by a user. File moved to /rejected folder.',
    'move_reason_failed' => 'Processing failed. File moved to /failed folder.',
    'move_reason_validated' => 'Validated and waiting for processing completion before archive movement.',
    'move_reason_pending' => 'Pending intake/validation; file typically remains in /incoming.',
    'failure_code_unknown' => 'Unknown failure code',
    'failure_code_pv_not_validated' => 'Proposal not validated yet',
    'failure_code_pv_no_company' => 'No company assigned',
    'failure_code_pv_not_downloaded' => 'File download not ready',
    'failure_code_pv_local_file_missing' => 'Local file missing on disk',
    'failure_code_pv_processing_exception' => 'Processing pipeline exception',
    'failure_code_pv_job_permanent_failure' => 'Processing job permanently failed',
    'failure_code_sp_duplicate_lock' => 'Duplicate processing lock active',
    'failure_code_sp_existing_proposal' => 'Proposal already exists for this file',
    ...
    'employee_access_diagnostic' => 'Employee Access Diagnostic',
    'employee_access_diagnostic_description' => 'Check why this employee may see fewer payslips on their dashboard than expected, and repair common linking issues.',
    'run_diagnostic' => 'Run Diagnostic',
    'run_diagnostic_to_see_results' => 'Click "Run Diagnostic" to inspect employee payslip visibility.',
    'linked_to_employee' => 'Linked to this employee',
    'visible_on_employee_dashboard' => 'Visible on employee dashboard',
    'relink_payslips_to_employee' => 'Relink payslips to this employee',
    'restore_deleted_payslips' => 'Restore deleted payslips',
    'encrypt_unencrypted_payslips' => 'Encrypt payslips with files',
    'employee_payslips_relinked' => 'Relinked :relinked payslip(s) and synced :synced matricule field(s).',
    'employee_deleted_payslips_restored' => 'Restored :count deleted payslip(s).',
    'employee_payslips_encrypted' => 'Encrypted :encrypted payslip(s); :failed failed.',
    'diagnostic_duplicate_accounts' => ':count duplicate employee account(s) share this matricule in the same company.',
    'diagnostic_payslips_on_sibling_accounts' => ':count payslip(s) are linked to another account with the same matricule.',
    'diagnostic_soft_deleted' => ':count soft-deleted payslip(s) are hidden from the employee dashboard.',
    'diagnostic_matricule_mismatch' => ':count linked payslip(s) have a matricule that differs from this employee record.',
    'diagnostic_missing_files' => ':count visible payslip(s) are missing PDF files on disk.',
    'diagnostic_unencrypted_with_file' => ':count payslip(s) have files but encryption is not marked successful.',
    'diagnostic_visible_more_than_linked' => 'Employee dashboard can show :visible payslip(s) while only :linked are linked directly to this account.',
    'diagnostic_healthy' => 'No employee access issues detected for this account.',
    'diagnostic_no_payslips' => 'No payslips were found for this employee.',
    'diagnostic_severity_success' => 'OK',
    'diagnostic_severity_info' => 'Info',
    'diagnostic_severity_warning' => 'Warning',
    'diagnostic_severity_danger' => 'Critical',
];
