...
return [
    /*
    |--------------------------------------------------------------------------
    | Roles Management Language Lines
    |--------------------------------------------------------------------------
    */
    ...
    'manage_all_permissions_and_roles' => 'Gérer toutes les permissions et rôles',
    'create_new_role_allocate_permissions' => 'Créer un nouveau rôle et allouer des permissions',
    'update_role_modify_permissions' => 'Mettre à jour le rôle et modifier les permissions',
    ...
    // Messages
    'cannot_delete_role_with_users' => 'Impossible de supprimer un rôle qui a des utilisateurs assignés.',
    'role_has_users_assigned' => 'Ce rôle a des utilisateurs qui lui sont assignés.',
    'select_at_least_one_permission' => 'Veuillez sélectionner au moins une permission.',
    'role_name_required' => 'Le nom du rôle est requis.',
    'role_name_unique' => 'Le nom du rôle doit être unique.',
    ...
    'role_information' => 'Informations du rôle',
