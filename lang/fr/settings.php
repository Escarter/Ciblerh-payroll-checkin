...
return [
    ...
    */
    ...
    'mailchimp_smtp_note' => 'Mailchimp Transactionnel envoie via l\'API HTTP Mandrill. Seule la clé API est requise — aucun hôte ou port SMTP nécessaire.',
    ...
    'mailchimp_webhook_step_3' => 'Cliquez sur "Ajouter un webhook" et sélectionnez les événements: Rebond dur, Rebond doux, Spam, Rejeté',
    ...
    'orange_cm_info_title' => 'Orange Cameroun — Business Messaging Ngage',
    'orange_cm_description' => 'Envoie des SMS via l’API Business Messaging Ngage d’Orange Cameroun. Utilisez les mêmes identifiants (email et mot de passe) que sur l’interface web Ngage (businessmessaging.orange.cm).',
    'orange_cm_step_1' => 'Créez un compte Business Messaging Ngage sur businessmessaging.orange.cm',
    'orange_cm_step_2' => 'Utilisez votre email de connexion et votre mot de passe Ngage (les mêmes que sur l’interface web et l’API)',
    'orange_cm_step_3' => 'Renseignez votre expéditeur enregistré (identifiant alphanumérique ou code court). Les numéros sont envoyés au format international (ex : 2376XXXXXXXX).',
    'orange_cm_pricing' => 'Tarification par packs via Orange (FCFA selon bundle)',
    'orange_cm_docs' => 'Business Messaging Ngage',
    'orange_cm_section_intro' => 'Connexion Business Messaging Ngage — les mêmes email et mot de passe que sur l’interface web Ngage (businessmessaging.orange.cm).',
    'orange_cm_login_email' => 'Email de connexion',
    'orange_cm_password' => 'Mot de passe',
    'orange_cm_sender' => 'Expéditeur',
    'orange_cm_login_email_placeholder' => 'nom@entreprise.com',
    'orange_cm_password_placeholder' => 'Mot de passe du compte Ngage',
    'orange_cm_sender_placeholder' => 'ex : Corporate',
    'orange_cm_sender_help' => 'Votre expéditeur enregistré (identifiant alphanumérique ou code court) tel qu’approuvé par Orange.',
    'orange_cm_category' => 'Catégorie SMS',
    'orange_cm_category_placeholder' => 'ex : Promo',
    'orange_cm_category_help' => 'Catégorie du message acceptée par votre compte Ngage (ex : Promo). Une valeur non prise en charge est rejetée (« Invalid Payload »).',
    'orange_cm_country' => 'Code pays',
    'orange_cm_country_placeholder' => 'ex : CM',
    'orange_cm_country_help' => 'Code pays ISO des destinataires (Cameroun = CM).',
    'orange_cm_dr_callback' => 'URL de rappel des accusés de réception',
    'orange_cm_dr_callback_placeholder' => 'https://votre-app.example/orange/dr (facultatif)',
    'orange_cm_dr_callback_help' => 'Remplacement facultatif. Laissez vide pour utiliser automatiquement le point de terminaison intégré de l’application (recommandé).',
    ...
    'test_sms_queued_orange_cm' => 'Orange Ngage a accepté la demande SMS. La livraison peut prendre quelques minutes ; utilisez un mobile camerounais au format international (+237…). Consultez l’interface web Ngage si le SMS n’arrive pas.',
    'test_sms_failed' => 'Échec de l\'envoi du SMS de test!',
    'sms_balance_not_available_short' => 'N/D',
    'sms_balance_orange_cm_help' => 'Le solde SMS restant n’est pas exposé par l’API Business Messaging Ngage. Consultez le volume de votre pack sur l’interface web Ngage (businessmessaging.orange.cm).',
    ...
    'sftp_push_archive_title' => 'Règles & fréquence d\'archivage',
    'sftp_push_archive_help' => 'Contrôle quand les fichiers sont déplacés hors de incoming et quels statuts sont éligibles au déplacement.',
    'sftp_push_archive_frequency_label' => 'Fréquence d\'archivage',
    'sftp_push_archive_frequency_follow_scan' => 'Suivre la fréquence de scan',
    'sftp_push_archive_time_label' => 'Archiver à l\'heure (HH:MM)',
    'sftp_push_archive_days_label' => 'Archiver les jours',
    'sftp_push_archive_min_age_label' => 'Âge minimum du fichier (minutes)',
    'sftp_push_archive_min_age_help' => 'Marge de sécurité avant le déplacement d\'un fichier éligible.',
    'sftp_push_archive_move_processed_label' => 'Déplacer les propositions traitées vers /processed',
    'sftp_push_archive_require_success_label' => 'Exiger un processus de paie réussi avant de déplacer les fichiers traités',
    'sftp_push_archive_move_rejected_label' => 'Déplacer les propositions rejetées vers /failed',
    'sftp_push_archive_move_failed_label' => 'Déplacer les propositions en échec vers /failed',
    'sftp_push_archive_effective_preview_label' => 'Comportement d\'archivage effectif :',
    'sftp_push_archive_effective_preview_frequency_scan' => 'fréquence héritée du scan',
    'sftp_push_archive_effective_preview_frequency_custom' => 'fréquence : :frequency',
    'sftp_push_archive_effective_preview_min_age' => 'âge min : :minutes min',
    'sftp_push_archive_effective_preview_rules' => 'règles — traité : :processed, rejeté : :rejected, échec : :failed, succès requis : :require_success',
    'day_sunday' => 'Dim',
    'day_monday' => 'Lun',
    'day_tuesday' => 'Mar',
    'day_wednesday' => 'Mer',
