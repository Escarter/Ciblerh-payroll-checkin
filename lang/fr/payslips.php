...
return [
    ...
    */
    ...
    'employee_access_diagnostic' => 'Diagnostic d\'accès employé',
    'employee_access_diagnostic_description' => 'Vérifiez pourquoi cet employé peut voir moins de fiches de paie sur son tableau de bord que prévu, et corrigez les problèmes de liaison courants.',
    'run_diagnostic' => 'Lancer le diagnostic',
    'run_diagnostic_to_see_results' => 'Cliquez sur "Lancer le diagnostic" pour inspecter la visibilité des fiches de paie.',
    'linked_to_employee' => 'Liées à cet employé',
    'visible_on_employee_dashboard' => 'Visibles sur le tableau de bord employé',
    'relink_payslips_to_employee' => 'Relier les fiches à cet employé',
    'restore_deleted_payslips' => 'Restaurer les fiches supprimées',
    'encrypt_unencrypted_payslips' => 'Chiffrer les fiches avec fichiers',
    'employee_payslips_relinked' => ':relinked fiche(s) reliée(s) et :synced champ(s) matricule synchronisé(s).',
    'employee_deleted_payslips_restored' => ':count fiche(s) supprimée(s) restaurée(s).',
    'employee_payslips_encrypted' => ':encrypted fiche(s) chiffrée(s) ; :failed en échec.',
    'diagnostic_duplicate_accounts' => ':count compte(s) employé en double partagent ce matricule dans la même société.',
    'diagnostic_payslips_on_sibling_accounts' => ':count fiche(s) sont liées à un autre compte avec le même matricule.',
    'diagnostic_soft_deleted' => ':count fiche(s) supprimée(s) sont masquées du tableau de bord employé.',
    'diagnostic_matricule_mismatch' => ':count fiche(s) liée(s) ont un matricule différent de celui de cet employé.',
    'diagnostic_missing_files' => ':count fiche(s) visible(s) n\'ont pas de fichier PDF sur le disque.',
    'diagnostic_unencrypted_with_file' => ':count fiche(s) ont un fichier mais le chiffrement n\'est pas marqué comme réussi.',
    'diagnostic_visible_more_than_linked' => 'Le tableau de bord employé peut afficher :visible fiche(s) alors que seulement :linked sont liées directement à ce compte.',
    'diagnostic_healthy' => 'Aucun problème d\'accès employé détecté pour ce compte.',
    'diagnostic_no_payslips' => 'Aucune fiche de paie trouvée pour cet employé.',
    'diagnostic_severity_success' => 'OK',
    'diagnostic_severity_info' => 'Info',
    'diagnostic_severity_warning' => 'Avertissement',
    'diagnostic_severity_danger' => 'Critique',
];
