...
class AbsencesExportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $export = new AbsencesExport($company, $filters['query_string'] ?? '');
            ...
            \Log::info("Absences export generated successfully", [
            ...
            \Log::error("Absences export failed", [
                'job_id' => $this->downloadJob->id,
                'error' => $e->getMessage()
            ]);
        }
    ...
    private function generateFilename(): string
    {
        ...
        $random = Str::random(5);
        return "AbsencesExport_{$timestamp}_{$random}.xlsx";
    }
}
