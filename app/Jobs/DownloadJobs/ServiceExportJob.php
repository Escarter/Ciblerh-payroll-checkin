...
class ServiceExportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $export = new ServiceExport($company, $filters['query_string'] ?? '');
            ...
            // Log success
            \Log::info("Service export generated successfully", [
    ...
    private function generateFilename(): string
    {
        ...
        return "ServiceExport_{$timestamp}_{$random}.xlsx";
    }
}
