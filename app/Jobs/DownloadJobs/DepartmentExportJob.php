...
class DepartmentExportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $export = new DepartmentExport($company, $filters['query_string'] ?? '');
            ...
            \Log::info("Department export generated successfully", [
            ...
            \Log::error("Department export failed", [
                'job_id' => $this->downloadJob->id,
                'error' => $e->getMessage()
            ]);
        }
    ...
    private function generateFilename(): string
    {
        ...
        $random = Str::random(5);
        return "DepartmentExport_{$timestamp}_{$random}.xlsx";
    }
}
