...
class ChecklogReportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            // Log success
            \Log::info("Checklog report generated successfully", [
            ...
            \Log::error("Checklog report failed", [
                'job_id' => $this->downloadJob->id,
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    private function generateFilename(): string
    {
        ...
        return "ChecklogReport_{$timestamp}_{$random}.xlsx";
    }
}
