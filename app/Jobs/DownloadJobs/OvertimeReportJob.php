...
class OvertimeReportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $export = new OvertimeExport(
                $filters['selectedCompanyId'] ?? 'all',
                $filters['selectedDepartmentId'] ?? 'all',
            ...
            // Log success
            \Log::info("Overtime report generated successfully", [
            ...
            \Log::error("Overtime report failed", [
                'job_id' => $this->downloadJob->id,
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
    ...
    private function generateFilename(): string
    {
        ...
        return "OvertimeReport_{$timestamp}_{$random}.xlsx";
    }
}
