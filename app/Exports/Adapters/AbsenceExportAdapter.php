...
class AbsenceExportAdapter extends BaseExportAdapter
{
    ...
    public function getColumnDefinitions(): array
    {
        return [
            ...
            ['field' => 'absence_date',      'label' => __('common.date'),         'default' => true],
            ['field' => 'reason',            'label' => __('common.reason'),       'default' => true],
            ['field' => 'justification',     'label' => __('common.justification'), 'default' => false],
    ...
    {
        $query = Absence::query()->with(['user', 'company']);
    ...
    protected function mapRow($model): array
    {
        ...
        foreach ($cols as $col) {
            $row[] = match ($col) {
                ...
                'absence_date'       => $model->absence_date?->format('Y-m-d') ?? '',
