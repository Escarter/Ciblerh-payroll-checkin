    ...
    public function bulkDelete()
    {
        ...
        if ($deleted > 0) {
            auditLog(
                ...
                'web',
                'bulk_deleted_download_jobs',
                    null,
                    [],
                    [],
                    [
                        'translation_key' => 'bulk_deleted_download_jobs',
                        'translation_params' => ['count' => $deleted],
                        'bulk_operation' => true,
    ...
    public function bulkRestore()
    {
        ...
        if ($restored > 0) {
            auditLog(
                ...
                'web',
                'bulk_restored_download_jobs',
                    null,
                    [],
                    [],
                    [
                        'translation_key' => 'bulk_restored_download_jobs',
                        'translation_params' => ['count' => $restored],
                        'bulk_operation' => true,
    ...
    public function bulkForceDelete()
    {
        ...
        if ($deleted > 0) {
            auditLog(
                ...
                'web',
                'bulk_force_deleted_download_jobs',
                    null,
                    [],
                    [],
                    [
                        'translation_key' => 'bulk_force_deleted_download_jobs',
                        'translation_params' => ['count' => $deleted],
                        'bulk_operation' => true,
