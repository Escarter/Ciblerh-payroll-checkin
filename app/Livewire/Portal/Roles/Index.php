        ...
        if (!empty($targetIds)) {
            ...
            if ($roles->count() > 0) {
                auditLog(
                    ...
                    [],
                    [
                        'translation_key' => 'bulk_deleted_roles',
                        'translation_params' => ['count' => $roles->count()],
                        'bulk_operation' => true,
        ...
        if (!empty($targetIds)) {
            ...
            if ($roles->count() > 0) {
                auditLog(
                    ...
                    [],
                    [
                        'translation_key' => 'bulk_restored_roles',
                        'translation_params' => ['count' => $roles->count()],
                        'bulk_operation' => true,
        ...
        if (!empty($targetIds)) {
            ...
            if ($roles->count() > 0) {
                auditLog(
                    ...
                    'web',
                    'bulk_force_deleted_roles',
                    null,
                    [],
                    [],
                    [
                        'translation_key' => 'bulk_force_deleted_roles',
