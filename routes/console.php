 ...
 */
if (!function_exists('getDeactivationTime')) {
 ...
 */
if (!function_exists('isDeactivationEnabled')) {
 ...
 */
if (!function_exists('applySftpPushScanFrequency')) {
 ...
 */
if (!function_exists('applySftpPushArchiveFrequency')) {
 ...
 */
if (!function_exists('getSftpSyncFrequency')) {
 ...
 */
if (!function_exists('isSftpSyncEnabled')) {
